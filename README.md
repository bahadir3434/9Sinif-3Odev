...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1QzapB6igTx2Eyjn4g3uOFtDH6qJAiYv0E3_hcsTRquM/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **0=0,1+0,1x+0x'2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? ***?***

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? ***hayır***

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) ***c***
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1YYpFPAXs7lRujEwe9NhBHhwUgAcEp2ggdmS-zc0JwKQ/edit#gid=0) link veriniz.
...
3) İvme'yi ne buldunuz? Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz. ***ivme değerini tam olarak bulamadım...
